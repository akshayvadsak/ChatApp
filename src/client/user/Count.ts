...
export class Count {
  ...
  public static async IncrementCount(
    countType: string,
    num: number = 1
  ): Promise<void> {
    const firestore = getFirestore();
  ...
  public static async DecrementCount(
    countType: string,
    num: number = 1
  ): Promise<void> {
    const firestore = getFirestore();
...
export class CountTypes {
  ...
  public static get CHATTER(): string {
    return "chatter_count";
  }
  public static get PROFILE_CREATOR(): string {
    return "profile_creator_count";
  }
